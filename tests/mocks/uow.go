...
// Source: github.com/yogenyslav/loyalty/pkg/database (interfaces: UnitOfWork)
//
...
func (m *MockUnitOfWork) WithTx(ctx context.Context, level database.TxLevel, fn func(context.Context) error) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "WithTx", ctx, level, fn)
	ret0, _ := ret[0].(error)
	return ret0
}

// WithTx indicates an expected call of WithTx.
func (mr *MockUnitOfWorkMockRecorder) WithTx(ctx, level, fn any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "WithTx", reflect.TypeOf((*MockUnitOfWork)(nil).WithTx), ctx, level, fn)
}
